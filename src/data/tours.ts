...
export const tours: Tour[] = [
  {
    ...
    images: ["/images/tours/sandwich-harbour-1.png", "/images/tours/sandwich-harbour-2.png", "/images/tours/sandwich-harbour-3.png", "/images/tours/sandwich-harbour-4.png"],
    gallery: [
      { src: "/images/tours/sandwich-harbour-1.png", alt: "Sandwich Harbour dunes" },
      { src: "/images/tours/sandwich-harbour-2.png", alt: "Sandwich Harbour lagoon" },
      { src: "/images/tours/sandwich-harbour-3.png", alt: "Sandwich Harbour 4x4" },
      { src: "/images/tours/sandwich-harbour-4.png", alt: "Sandwich Harbour ocean view" },
    ],
  },
  {
    ...
    images: ["/images/tours/catamaran-dolphin-cruise-1.png", "/images/tours/catamaran-dolphin-cruise-2.png", "/images/tours/catamaran-dolphin-cruise-3.png"],
    gallery: [
      { src: "/images/tours/catamaran-dolphin-cruise-1.png", alt: "Catamaran cruise departure" },
      { src: "/images/tours/catamaran-dolphin-cruise-2.png", alt: "Dolphins alongside" },
      { src: "/images/tours/catamaran-dolphin-cruise-3.png", alt: "Seals on rocks" },
    ],
  },
  {
    ...
    images: ["/images/tours/spitzkoppe-adventure-1.png", "/images/tours/spitzkoppe-adventure-2.png", "/images/tours/spitzkoppe-adventure-3.png", "/images/tours/spitzkoppe-adventure-4.png"],
    gallery: [
      { src: "/images/tours/spitzkoppe-adventure-1.png", alt: "Spitzkoppe peaks" },
      { src: "/images/tours/spitzkoppe-adventure-2.png", alt: "Rock art" },
      { src: "/images/tours/spitzkoppe-adventure-3.png", alt: "Granite arch" },
      { src: "/images/tours/spitzkoppe-adventure-4.png", alt: "Desert landscape" },
  ...
  },
  {
    ...
    images: ["/images/tours/skeleton-coast-1.png", "/images/tours/skeleton-coast-2.png", "/images/tours/skeleton-coast-3.png"],
    gallery: [
      { src: "/images/tours/skeleton-coast-1.png", alt: "Skeleton Coast shipwreck" },
      { src: "/images/tours/skeleton-coast-2.png", alt: "Seal colony" },
      { src: "/images/tours/skeleton-coast-3.png", alt: "Coastal fog" },
      { src: "/images/tours/skeleton-coast-4.png", alt: "Desert coastline" },
      { src: "/images/tours/skeleton-coast-5.png", alt: "Zeila shipwreck" },
    ],
  },
  {
    ...
    images: ["/images/tours/moon-valley-welwitschia-1.png", "/images/tours/moon-valley-welwitschia-2.png", "/images/tours/moon-valley-welwitschia-3.png"],
    gallery: [
      { src: "/images/tours/moon-valley-welwitschia-1.png", alt: "Moon Valley landscape" },
      { src: "/images/tours/moon-valley-welwitschia-2.png", alt: "Welwitschia plant" },
      { src: "/images/tours/moon-valley-welwitschia-3.png", alt: "Desert canyon" },
      { src: "/images/tours/moon-valley-welwitschia-4.png", alt: "Rock formations" },
      { src: "/images/tours/moon-valley-welwitschia-5.png", alt: "Geological layers" },
    ],
  },
  {
    ...
    images: ["/images/tours/swakopmund-town-tour-1.png", "/images/tours/swakopmund-town-tour-2.png"],
    gallery: [
      { src: "/images/tours/swakopmund-town-tour-1.png", alt: "Swakopmund architecture" },
      { src: "/images/tours/swakopmund-town-tour-2.png", alt: "Swakopmund Jetty" },
    ],
  },
  {
    ...
    images: ["/images/tours/classic-namibia-safari-1.png", "/images/tours/classic-namibia-safari-2.jpg", "/images/tours/classic-namibia-safari-3.jpg"],
    gallery: [
      { src: "/images/tours/classic-namibia-safari-1.png", alt: "Namibian safari landscape" },
  ...
  },
  {
    ...
    images: ["/images/tours/catamaran-dolphin-cruise-1.png", "/images/tours/sandwich-harbour-1.png"],
    gallery: [
      { src: "/images/tours/catamaran-dolphin-cruise-1.png", alt: "Catamaran morning" },
      { src: "/images/tours/sandwich-harbour-1.png", alt: "Sandwich Harbour afternoon" },
    ],
  },
];
