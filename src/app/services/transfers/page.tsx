        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="double-bezel-outer">
            <div className="double-bezel-inner overflow-hidden relative aspect-[21/9] md:aspect-[3/1]">
              <Image alt="White ProAvia-branded Volkswagen Tiguan parked at a Windhoek tyre service centre" width={1920} height={640} className="object-cover w-full h-full" sizes="100vw" src="/images/vehicles/proavia-fleet-vw-tiguan-windhoek.webp" priority />
